...
Eigen::VectorXd optimization_abstract::residual(
    const Eigen::VectorXd &domain,
    const Eigen::VectorXd &range,
...
Eigen::VectorXd optimization_abstract::derivative(
    const Eigen::VectorXd &domain,
    const Eigen::VectorXd &range,
...
Eigen::MatrixXd optimization_abstract::jacobian(
    const Eigen::VectorXd &domain,
    const Eigen::VectorXd &range) {
...
Eigen::VectorXd optimization_abstract::step_iteration(
    const Eigen::VectorXd &domain,
    const Eigen::VectorXd &range,
    const double damp) {
