...
int main(int argc, char **argv) {
	...
	interface_singleton::instance().command_setup(std::make_unique<command_correlation>());
	interface_singleton::instance().command_setup(std::make_unique<command_fourier>());
